...
const translations = {
  en: {
    ...
    whatsappInfoNote: "💡 By agreeing, a welcome message will be sent to your WhatsApp to activate notifications. You can unsubscribe at any time from your account settings.",
  ...
  ar: {
    ...
    whatsappInfoNote: "💡 بالموافقة، سيتم إرسال رسالة ترحيبية إلى واتساب الخاص بك لتنشيط الخدمة. يمكنك إلغاء الاشتراك في أي وقت من إعدادات حسابك.",

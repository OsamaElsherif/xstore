      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border border-brand-gray/10">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-display font-bold text-brand-dark mb-2">{t('welcomeTitleSignup')}</h1>
            <p className="text-brand-gray text-sm">{t('welcomeSubtitleSignup')}</p>
          </div>
          ...
          <form action={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-brand-dark mb-1.5">{t('fullName')}</label>
            ...
            <div>
              <label className="block text-sm font-medium text-brand-dark mb-1.5">{t('password')}</label>
              <div className="relative">
                <div className="absolute inset-y-0 ltr:left-0 rtl:right-0 ltr:pl-3 rtl:pr-3 flex items-center pointer-events-none text-brand-gray">
                  <Lock size={18} />
                </div>
